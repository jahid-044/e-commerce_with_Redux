...
export default function Checkout() {
    const { cart, setCart, totalAmount, setTotalAmount, totalQuantity, setTotalQuantity } = useContext(modalContext);
        ...
        <div className="mx-4 sm:mx-20">
            <div className="container sm:p-12 mx-auto">
                <div className="flex flex-col w-full px-0 mx-auto md:flex-row">
                    ...
                    <div className="flex flex-col w-full ml-0 sm:ml-8 lg:w-2/5">
                        <div className="pt-12 md:pt-0 2xl:ps-4">
                                            ...
                                            return (
                                                ...
                                                <div className="flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-red-600">Price</span> ${cartItem.item.price}
                                                    </div>
                            ...
                            <div
                                ...
                                Subtotal<span className="ml-2">${totalAmount.toFixed(2)}</span></div>
                            <div
                                className="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                                Shipping Tax<span className="ml-2">$10.00</span></div>
                            <div
                                className="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                                Total<span className="ml-2">${(totalAmount + 10).toFixed(2)}</span></div>
                        </div>
                    </div>
                </div>
            </div>
